...
public class GameManager : MonoBehaviour
{
    ...
    private void Update()
    {
        // Faz com que as bolham sumam aos poucos ao serem explodidam
        if (isDissolving)
        {
            foreach (Transform bubble in bubblesToDissolve)
            {
                if (bubble == null)
                {
                    // garante que todas as bolhas desapareçam antes de terminar de dissolve-las
